...
def get_network(model_path):
    if 'REDS' in model_path:
        ...
        print('Illegal model: not implemented!')
        sys.exit(1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./logs/BebyGAN_x4/models/420000_G.pth')
    parser.add_argument('--input_path', type=str, default='../datasets/lr-beby/')
    parser.add_argument('--output_path', type=str, default='../output/beby/')
    parser.add_argument('--gt_path', type=str, default='../datasets/hr/')
    ...
    load_model(model, args.model_path, device, strict=True)
    ...
    if args.sr_type == 'SISR':
        ...
        print('Illegal SR type: not implemented!')
        sys.exit(1)
