...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='super_res-800_100', help='name of the experiment. It decides where to store samples and models')        
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='../datasets/800x100') 
