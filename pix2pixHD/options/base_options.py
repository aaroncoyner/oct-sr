...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='oct-sr', help='name of the experiment. It decides where to store samples and models')        
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='../datasets/pix2pix') 
